...
onready var drop_target = get_node("/root/DragAndDropDemo/VLayout/ColumnContainer/TargetColumn")
onready var draggable_scene: PackedScene = preload("res://_dev/primo/Scenes/ext/draggable.tscn")
